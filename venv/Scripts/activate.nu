...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Telusko project\python pro\movies_pickle_Project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Telusko project\python pro\movies_pickle_Project\venv\Scripts\deactivate.nu'
